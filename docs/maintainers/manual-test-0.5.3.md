...
**App:** `/Applications/MagSafeGuard-0.5.3.app` (Release-Build; Spotlight: „MagSafe Guard“)  
...
- [x] Nach Ablauf: **Security Actions** laufen (mind. Lock) *(Logout getestet, Dev-Session)*
